...
pickle_in = open('saved_models/RandomForest.pkl', 'rb')
...
def Forminfo(request):
    try: 
        ...
        return render(request, 'result.html',{'result':y_pred})
            ...
            # Handle the case where the key is not found in the request.GET dictionary
            # You can log the error or provide a suitable response to the user
            return HttpResponse("Error: Missing form field", status=400)